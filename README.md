...
## Results (latest snapshot: 2026-07-21 11:26 ET, SPY spot 747.76)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,225 |
| Survive liquidity filter | 2,393 (74%) |
| IV solved via Newton | 1,352 (56%) |
| IV solved via Brent fallback | 687 (29%) |
| Failed (no root / outside bounds) | 354 (14.8%) |
...
The 354 failures cluster in the shortest expiries and deep-ITM strikes; 295 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
ATM IV currently averages 13.7% for expiries within a week vs 14.2% around one month: an **upward-sloping (contango)** curve, the normal calm-market shape — near-term realized vol is expected to stay low, while longer horizons carry a risk premium for the things that haven't happened yet.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 455 zero-bid contracts dropped and 377 more for spreads wider than 20% of mid.
...
- **14.8% of IV solves failed** (354 contracts, mostly the shortest expiries and deep-ITM strikes); 295 were prices below intrinsic value — quotes that genuinely admit no implied vol.
