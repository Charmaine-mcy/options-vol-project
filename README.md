...
## Results (latest snapshot: 2026-08-03 12:07 ET, SPY spot 755.98)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 2,869 |
| Survive liquidity filter | 2,098 (73%) |
| IV solved via Newton | 1,345 (64%) |
| IV solved via Brent fallback | 578 (28%) |
| Failed (no root / outside bounds) | 175 (8.3%) |
...
The 175 failures cluster in the shortest expiries and deep-ITM strikes; 134 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
ATM IV currently averages 10.5% for expiries within a week vs 12.6% around one month: an **upward-sloping (contango)** curve, the normal calm-market shape — near-term realized vol is expected to stay low, while longer horizons carry a risk premium for the things that haven't happened yet.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 394 zero-bid contracts dropped and 377 more for spreads wider than 20% of mid.
...
- **8.3% of IV solves failed** (175 contracts, mostly the shortest expiries and deep-ITM strikes); 134 were prices below intrinsic value — quotes that genuinely admit no implied vol.
