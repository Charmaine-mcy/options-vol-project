...
## Results (latest snapshot: 2026-08-20 13:57 ET, SPY spot 764.80)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,779 |
| Survive liquidity filter | 2,856 (76%) |
| IV solved via Newton | 1,805 (63%) |
| IV solved via Brent fallback | 780 (27%) |
| Failed (no root / outside bounds) | 271 (9.5%) |
...
The 271 failures cluster in the shortest expiries and deep-ITM strikes; 146 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
ATM IV currently averages 11.8% for expiries within a week vs 12.9% around one month: an **upward-sloping (contango)** curve, the normal calm-market shape — near-term realized vol is expected to stay low, while longer horizons carry a risk premium for the things that haven't happened yet.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 415 zero-bid contracts dropped and 508 more for spreads wider than 20% of mid.
...
- **9.5% of IV solves failed** (271 contracts, mostly the shortest expiries and deep-ITM strikes); 146 were prices below intrinsic value — quotes that genuinely admit no implied vol.
