...
## Results (latest snapshot: 2026-08-11 11:30 ET, SPY spot 772.47)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,554 |
| Survive liquidity filter | 2,680 (75%) |
| IV solved via Newton | 1,776 (66%) |
| IV solved via Brent fallback | 762 (28%) |
| Failed (no root / outside bounds) | 142 (5.3%) |
...
The 142 failures cluster in the shortest expiries and deep-ITM strikes; 142 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
Under Black-Scholes assumptions the IV-vs-strike line would be flat. Instead SPY shows the classic **equity skew**: the 04 Sep 2026 expiry prices 13% at the money vs 23% for puts 10% below spot (+10.6 vol pts). Three standard explanations, all pushing the same direction:
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 448 zero-bid contracts dropped and 426 more for spreads wider than 20% of mid.
...
- **5.3% of IV solves failed** (142 contracts, mostly the shortest expiries and deep-ITM strikes); 142 were prices below intrinsic value — quotes that genuinely admit no implied vol.
