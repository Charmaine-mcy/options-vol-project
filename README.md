...
## Results (latest snapshot: 2026-07-21 10:55 ET, SPY spot 746.64)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,225 |
| Survive liquidity filter | 2,400 (74%) |
| IV solved via Newton | 1,545 (64%) |
| IV solved via Brent fallback | 700 (29%) |
| Failed (no root / outside bounds) | 155 (6.5%) |
...
The 155 failures cluster in the shortest expiries and deep-ITM strikes; 101 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 445 zero-bid contracts dropped and 380 more for spreads wider than 20% of mid.
...
- **6.5% of IV solves failed** (155 contracts, mostly the shortest expiries and deep-ITM strikes); 101 were prices below intrinsic value — quotes that genuinely admit no implied vol.
