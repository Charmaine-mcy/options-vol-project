...
## Results (latest snapshot: 2026-08-12 11:30 ET, SPY spot 772.32)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,604 |
| Survive liquidity filter | 2,751 (76%) |
| IV solved via Newton | 1,830 (67%) |
| IV solved via Brent fallback | 771 (28%) |
| Failed (no root / outside bounds) | 150 (5.5%) |
...
The 150 failures cluster in the shortest expiries and deep-ITM strikes; 119 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
ATM IV currently averages 11.2% for expiries within a week vs 12.3% around one month: an **upward-sloping (contango)** curve, the normal calm-market shape — near-term realized vol is expected to stay low, while longer horizons carry a risk premium for the things that haven't happened yet.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 409 zero-bid contracts dropped and 444 more for spreads wider than 20% of mid.
...
- **5.5% of IV solves failed** (150 contracts, mostly the shortest expiries and deep-ITM strikes); 119 were prices below intrinsic value — quotes that genuinely admit no implied vol.
