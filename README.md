...
## Results (latest snapshot: 2026-09-03 15:23 ET, SPY spot 773.38)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,834 |
| Survive liquidity filter | 2,988 (78%) |
| IV solved via Newton | 1,987 (66%) |
| IV solved via Brent fallback | 853 (29%) |
| Failed (no root / outside bounds) | 148 (5.0%) |
...
The 148 failures cluster in the shortest expiries and deep-ITM strikes; 114 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
Under Black-Scholes assumptions the IV-vs-strike line would be flat. Instead SPY shows the classic **equity skew**: the 02 Oct 2026 expiry prices 12% at the money vs 22% for puts 10% below spot (+10.3 vol pts). Three standard explanations, all pushing the same direction:
...
ATM IV currently averages 10.8% for expiries within a week vs 11.8% around one month: an **upward-sloping (contango)** curve, the normal calm-market shape — near-term realized vol is expected to stay low, while longer horizons carry a risk premium for the things that haven't happened yet.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 441 zero-bid contracts dropped and 405 more for spreads wider than 20% of mid.
...
- **5.0% of IV solves failed** (148 contracts, mostly the shortest expiries and deep-ITM strikes); 114 were prices below intrinsic value — quotes that genuinely admit no implied vol.
