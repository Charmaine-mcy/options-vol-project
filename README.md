...
## Results (latest snapshot: 2026-09-18 13:48 ET, SPY spot 759.74)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,756 |
| Survive liquidity filter | 2,803 (75%) |
| IV solved via Newton | 1,562 (56%) |
| IV solved via Brent fallback | 727 (26%) |
| Failed (no root / outside bounds) | 514 (18.3%) |
...
The 514 failures cluster in the shortest expiries and deep-ITM strikes; 338 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
Under Black-Scholes assumptions the IV-vs-strike line would be flat. Instead SPY shows the classic **equity skew**: the 16 Oct 2026 expiry prices 13% at the money vs 24% for puts 10% below spot (+11.0 vol pts). Three standard explanations, all pushing the same direction:
...
ATM IV currently averages 9.6% for expiries within a week vs 12.7% around one month: an **upward-sloping (contango)** curve, the normal calm-market shape — near-term realized vol is expected to stay low, while longer horizons carry a risk premium for the things that haven't happened yet.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 557 zero-bid contracts dropped and 396 more for spreads wider than 20% of mid.
...
- **18.3% of IV solves failed** (514 contracts, mostly the shortest expiries and deep-ITM strikes); 338 were prices below intrinsic value — quotes that genuinely admit no implied vol.
