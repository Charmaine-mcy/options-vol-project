...
## Results (latest snapshot: 2026-09-08 13:22 ET, SPY spot 767.53)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,026 |
| Survive liquidity filter | 2,293 (76%) |
| IV solved via Newton | 1,403 (61%) |
| IV solved via Brent fallback | 649 (28%) |
| Failed (no root / outside bounds) | 241 (10.5%) |
...
The 241 failures cluster in the shortest expiries and deep-ITM strikes; 184 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
Under Black-Scholes assumptions the IV-vs-strike line would be flat. Instead SPY shows the classic **equity skew**: the 02 Oct 2026 expiry prices 12% at the money vs 24% for puts 10% below spot (+11.4 vol pts). Three standard explanations, all pushing the same direction:
...
ATM IV currently averages 11.4% for expiries within a week vs 12.1% around one month: an **upward-sloping (contango)** curve, the normal calm-market shape — near-term realized vol is expected to stay low, while longer horizons carry a risk premium for the things that haven't happened yet.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 370 zero-bid contracts dropped and 363 more for spreads wider than 20% of mid.
...
- **10.5% of IV solves failed** (241 contracts, mostly the shortest expiries and deep-ITM strikes); 184 were prices below intrinsic value — quotes that genuinely admit no implied vol.
