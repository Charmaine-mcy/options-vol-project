...
## Results (latest snapshot: 2026-09-16 13:42 ET, SPY spot 759.53)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,441 |
| Survive liquidity filter | 2,668 (78%) |
| IV solved via Newton | 1,458 (55%) |
| IV solved via Brent fallback | 813 (30%) |
| Failed (no root / outside bounds) | 397 (14.9%) |
...
The 397 failures cluster in the shortest expiries and deep-ITM strikes; 73 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
Under Black-Scholes assumptions the IV-vs-strike line would be flat. Instead SPY shows the classic **equity skew**: the 16 Oct 2026 expiry prices 14% at the money vs 25% for puts 10% below spot (+10.9 vol pts). Three standard explanations, all pushing the same direction:
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 290 zero-bid contracts dropped and 483 more for spreads wider than 20% of mid.
...
- **14.9% of IV solves failed** (397 contracts, mostly the shortest expiries and deep-ITM strikes); 73 were prices below intrinsic value — quotes that genuinely admit no implied vol.
