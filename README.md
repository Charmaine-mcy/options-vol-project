...
## Results (latest snapshot: 2026-08-20 11:07 ET, SPY spot 767.19)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,779 |
| Survive liquidity filter | 2,883 (76%) |
| IV solved via Newton | 1,693 (59%) |
| IV solved via Brent fallback | 793 (28%) |
| Failed (no root / outside bounds) | 397 (13.8%) |
...
The 397 failures cluster in the shortest expiries and deep-ITM strikes; 222 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
ATM IV currently averages 11.6% for expiries within a week vs 12.8% around one month: an **upward-sloping (contango)** curve, the normal calm-market shape — near-term realized vol is expected to stay low, while longer horizons carry a risk premium for the things that haven't happened yet.
...
No earnings inside the tracking window at the moment — the next report is 20 Oct 2026 (~61 days away); tracking resumes automatically inside the 60-day window. The chart shows the **archived analysis of the 16 Jul 2026 event**, rendered from numbers persisted at capture time (`data/earnings_archive_NFLX.json`), not recomputed:
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 391 zero-bid contracts dropped and 505 more for spreads wider than 20% of mid.
...
- **13.8% of IV solves failed** (397 contracts, mostly the shortest expiries and deep-ITM strikes); 222 were prices below intrinsic value — quotes that genuinely admit no implied vol.
