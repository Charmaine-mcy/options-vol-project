...
## Results (latest snapshot: 2026-08-11 10:37 ET, SPY spot 773.45)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,554 |
| Survive liquidity filter | 2,719 (77%) |
| IV solved via Newton | 1,775 (65%) |
| IV solved via Brent fallback | 803 (30%) |
| Failed (no root / outside bounds) | 141 (5.2%) |
...
The 141 failures cluster in the shortest expiries and deep-ITM strikes; 140 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
Under Black-Scholes assumptions the IV-vs-strike line would be flat. Instead SPY shows the classic **equity skew**: the 04 Sep 2026 expiry prices 13% at the money vs 23% for puts 10% below spot (+10.5 vol pts). Three standard explanations, all pushing the same direction:
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 441 zero-bid contracts dropped and 394 more for spreads wider than 20% of mid.
...
- **5.2% of IV solves failed** (141 contracts, mostly the shortest expiries and deep-ITM strikes); 140 were prices below intrinsic value — quotes that genuinely admit no implied vol.
