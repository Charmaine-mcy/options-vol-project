...
## Results (latest snapshot: 2026-09-18 13:09 ET, SPY spot 759.39)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,756 |
| Survive liquidity filter | 2,807 (75%) |
| IV solved via Newton | 1,726 (61%) |
| IV solved via Brent fallback | 760 (27%) |
| Failed (no root / outside bounds) | 321 (11.4%) |
...
The 321 failures cluster in the shortest expiries and deep-ITM strikes; 163 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
Under Black-Scholes assumptions the IV-vs-strike line would be flat. Instead SPY shows the classic **equity skew**: the 16 Oct 2026 expiry prices 13% at the money vs 24% for puts 10% below spot (+10.9 vol pts). Three standard explanations, all pushing the same direction:
...
ATM IV currently averages 9.9% for expiries within a week vs 12.8% around one month: an **upward-sloping (contango)** curve, the normal calm-market shape — near-term realized vol is expected to stay low, while longer horizons carry a risk premium for the things that haven't happened yet.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 563 zero-bid contracts dropped and 386 more for spreads wider than 20% of mid.
...
- **11.4% of IV solves failed** (321 contracts, mostly the shortest expiries and deep-ITM strikes); 163 were prices below intrinsic value — quotes that genuinely admit no implied vol.
