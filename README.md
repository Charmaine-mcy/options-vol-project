...
## Results (latest snapshot: 2026-09-11 13:51 ET, SPY spot 765.85)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,121 |
| Survive liquidity filter | 2,482 (80%) |
| IV solved via Newton | 1,396 (56%) |
| IV solved via Brent fallback | 737 (30%) |
| Failed (no root / outside bounds) | 349 (14.1%) |
...
The 349 failures cluster in the shortest expiries and deep-ITM strikes; 103 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
Under Black-Scholes assumptions the IV-vs-strike line would be flat. Instead SPY shows the classic **equity skew**: the 09 Oct 2026 expiry prices 12% at the money vs 24% for puts 10% below spot (+11.2 vol pts). Three standard explanations, all pushing the same direction:
...
ATM IV currently averages 10.0% for expiries within a week vs 12.6% around one month: an **upward-sloping (contango)** curve, the normal calm-market shape — near-term realized vol is expected to stay low, while longer horizons carry a risk premium for the things that haven't happened yet.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 321 zero-bid contracts dropped and 318 more for spreads wider than 20% of mid.
...
- **14.1% of IV solves failed** (349 contracts, mostly the shortest expiries and deep-ITM strikes); 103 were prices below intrinsic value — quotes that genuinely admit no implied vol.
