...
## Results (latest snapshot: 2026-09-21 14:52 ET, SPY spot 774.32)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,312 |
| Survive liquidity filter | 2,483 (75%) |
| IV solved via Newton | 1,118 (45%) |
| IV solved via Brent fallback | 686 (28%) |
| Failed (no root / outside bounds) | 679 (27.3%) |
...
The 679 failures cluster in the shortest expiries and deep-ITM strikes; 563 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
Under Black-Scholes assumptions the IV-vs-strike line would be flat. Instead SPY shows the classic **equity skew**: the 16 Oct 2026 expiry prices 12% at the money vs 24% for puts 10% below spot (+11.5 vol pts). Three standard explanations, all pushing the same direction:
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 368 zero-bid contracts dropped and 461 more for spreads wider than 20% of mid.
...
- **27.3% of IV solves failed** (679 contracts, mostly the shortest expiries and deep-ITM strikes); 563 were prices below intrinsic value — quotes that genuinely admit no implied vol.
