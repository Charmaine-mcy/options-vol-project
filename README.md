...
## Results (latest snapshot: 2026-07-21 10:25 ET, SPY spot 745.98)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,225 |
| Survive liquidity filter | 2,410 (75%) |
| IV solved via Newton | 1,443 (60%) |
| IV solved via Brent fallback | 703 (29%) |
| Failed (no root / outside bounds) | 264 (11.0%) |
...
The 264 failures cluster in the shortest expiries and deep-ITM strikes; 196 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
Under Black-Scholes assumptions the IV-vs-strike line would be flat. Instead SPY shows the classic **equity skew**: the 21 Aug 2026 expiry prices 15% at the money vs 25% for puts 10% below spot (+10.2 vol pts). Three standard explanations, all pushing the same direction:
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 449 zero-bid contracts dropped and 366 more for spreads wider than 20% of mid.
...
- **11.0% of IV solves failed** (264 contracts, mostly the shortest expiries and deep-ITM strikes); 196 were prices below intrinsic value — quotes that genuinely admit no implied vol.
