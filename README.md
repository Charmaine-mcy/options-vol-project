...
## Results (latest snapshot: 2026-09-11 15:14 ET, SPY spot 764.85)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,121 |
| Survive liquidity filter | 2,471 (79%) |
| IV solved via Newton | 1,516 (61%) |
| IV solved via Brent fallback | 745 (30%) |
| Failed (no root / outside bounds) | 210 (8.5%) |
...
The 210 failures cluster in the shortest expiries and deep-ITM strikes; 105 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
Under Black-Scholes assumptions the IV-vs-strike line would be flat. Instead SPY shows the classic **equity skew**: the 09 Oct 2026 expiry prices 13% at the money vs 24% for puts 10% below spot (+11.3 vol pts). Three standard explanations, all pushing the same direction:
...
ATM IV currently averages 10.8% for expiries within a week vs 12.7% around one month: an **upward-sloping (contango)** curve, the normal calm-market shape — near-term realized vol is expected to stay low, while longer horizons carry a risk premium for the things that haven't happened yet.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 325 zero-bid contracts dropped and 325 more for spreads wider than 20% of mid.
...
- **8.5% of IV solves failed** (210 contracts, mostly the shortest expiries and deep-ITM strikes); 105 were prices below intrinsic value — quotes that genuinely admit no implied vol.
