...
## Results (latest snapshot: 2026-08-10 11:32 ET, SPY spot 773.54)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,421 |
| Survive liquidity filter | 2,542 (74%) |
| IV solved via Newton | 1,653 (65%) |
| IV solved via Brent fallback | 702 (28%) |
| Failed (no root / outside bounds) | 187 (7.4%) |
...
The 187 failures cluster in the shortest expiries and deep-ITM strikes; 187 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 460 zero-bid contracts dropped and 419 more for spreads wider than 20% of mid.
...
- **7.4% of IV solves failed** (187 contracts, mostly the shortest expiries and deep-ITM strikes); 187 were prices below intrinsic value — quotes that genuinely admit no implied vol.
