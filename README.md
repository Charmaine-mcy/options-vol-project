...
## Results (latest snapshot: 2026-08-21 13:02 ET, SPY spot 766.36)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 4,136 |
| Survive liquidity filter | 3,180 (77%) |
| IV solved via Newton | 1,913 (60%) |
| IV solved via Brent fallback | 900 (28%) |
| Failed (no root / outside bounds) | 367 (11.5%) |
...
The 367 failures cluster in the shortest expiries and deep-ITM strikes; 222 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
Under Black-Scholes assumptions the IV-vs-strike line would be flat. Instead SPY shows the classic **equity skew**: the 18 Sep 2026 expiry prices 13% at the money vs 23% for puts 10% below spot (+10.7 vol pts). Three standard explanations, all pushing the same direction:
...
ATM IV currently averages 9.6% for expiries within a week vs 12.6% around one month: an **upward-sloping (contango)** curve, the normal calm-market shape — near-term realized vol is expected to stay low, while longer horizons carry a risk premium for the things that haven't happened yet.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 430 zero-bid contracts dropped and 526 more for spreads wider than 20% of mid.
...
- **11.5% of IV solves failed** (367 contracts, mostly the shortest expiries and deep-ITM strikes); 222 were prices below intrinsic value — quotes that genuinely admit no implied vol.
