...
## Results (latest snapshot: 2026-08-12 13:31 ET, SPY spot 772.78)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,604 |
| Survive liquidity filter | 2,741 (76%) |
| IV solved via Newton | 1,856 (68%) |
| IV solved via Brent fallback | 770 (28%) |
| Failed (no root / outside bounds) | 115 (4.2%) |
...
The 115 failures cluster in the shortest expiries and deep-ITM strikes; 113 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
Under Black-Scholes assumptions the IV-vs-strike line would be flat. Instead SPY shows the classic **equity skew**: the 11 Sep 2026 expiry prices 12% at the money vs 22% for puts 10% below spot (+9.8 vol pts). Three standard explanations, all pushing the same direction:
...
ATM IV currently averages 10.9% for expiries within a week vs 12.3% around one month: an **upward-sloping (contango)** curve, the normal calm-market shape — near-term realized vol is expected to stay low, while longer horizons carry a risk premium for the things that haven't happened yet.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 416 zero-bid contracts dropped and 447 more for spreads wider than 20% of mid.
...
- **4.2% of IV solves failed** (115 contracts, mostly the shortest expiries and deep-ITM strikes); 113 were prices below intrinsic value — quotes that genuinely admit no implied vol.
