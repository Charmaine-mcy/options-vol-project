...
## Results (latest snapshot: 2026-08-03 13:12 ET, SPY spot 756.55)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 2,869 |
| Survive liquidity filter | 2,083 (73%) |
| IV solved via Newton | 1,179 (57%) |
| IV solved via Brent fallback | 586 (28%) |
| Failed (no root / outside bounds) | 318 (15.3%) |
...
The 318 failures cluster in the shortest expiries and deep-ITM strikes; 260 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
ATM IV currently averages 10.4% for expiries within a week vs 12.6% around one month: an **upward-sloping (contango)** curve, the normal calm-market shape — near-term realized vol is expected to stay low, while longer horizons carry a risk premium for the things that haven't happened yet.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 400 zero-bid contracts dropped and 386 more for spreads wider than 20% of mid.
...
- **15.3% of IV solves failed** (318 contracts, mostly the shortest expiries and deep-ITM strikes); 260 were prices below intrinsic value — quotes that genuinely admit no implied vol.
