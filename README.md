...
## Results (latest snapshot: 2026-08-18 13:55 ET, SPY spot 767.98)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,396 |
| Survive liquidity filter | 2,532 (75%) |
| IV solved via Newton | 1,604 (63%) |
| IV solved via Brent fallback | 675 (27%) |
| Failed (no root / outside bounds) | 253 (10.0%) |
...
The 253 failures cluster in the shortest expiries and deep-ITM strikes; 160 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 337 zero-bid contracts dropped and 527 more for spreads wider than 20% of mid.
...
- **10.0% of IV solves failed** (253 contracts, mostly the shortest expiries and deep-ITM strikes); 160 were prices below intrinsic value — quotes that genuinely admit no implied vol.
