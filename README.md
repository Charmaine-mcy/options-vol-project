...
## Results (latest snapshot: 2026-08-10 13:27 ET, SPY spot 773.03)

| Stage | Count |
|---|---|
| Contracts pulled (12 expiries) | 3,421 |
| Survive liquidity filter | 2,534 (74%) |
| IV solved via Newton | 1,622 (64%) |
| IV solved via Brent fallback | 697 (28%) |
| Failed (no root / outside bounds) | 215 (8.5%) |
...
The 215 failures cluster in the shortest expiries and deep-ITM strikes; 141 of them are quotes sitting below intrinsic value — prices that genuinely admit no implied vol, which the solver refuses rather than forcing a number.
...
Under Black-Scholes assumptions the IV-vs-strike line would be flat. Instead SPY shows the classic **equity skew**: the 31 Aug 2026 expiry prices 12% at the money vs 23% for puts 10% below spot (+10.8 vol pts). Three standard explanations, all pushing the same direction:
...
- **This snapshot uses live bid/ask midpoints** (market-hours pull): 460 zero-bid contracts dropped and 427 more for spreads wider than 20% of mid.
...
- **8.5% of IV solves failed** (215 contracts, mostly the shortest expiries and deep-ITM strikes); 141 were prices below intrinsic value — quotes that genuinely admit no implied vol.
